...
run_test("paste_handler_converter", () => {
    ...
    */
    ...
    // Heading
    // This test case ensures that the `#` symbol is properly removed in such scenarios, aligning with the desired behavior of converting the heading to plain text.
    input =
