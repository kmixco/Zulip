...
test_people("basics", ({override}) => {
    ...
    // Test get_all_bots_for_current_user
    // and get_bot_ids_current_user returns empty array
    assert.deepEqual([], people.get_all_bots_for_current_user());
    assert.deepEqual([], people.get_bot_ids_current_user());

    people.add_active_user(my_bot1);
    people.add_active_user(my_bot2);

    // Test get_all_bots_for_current_user includes added bots my_bot1, my_bot2
    // and get_bot_ids_current_user includes respective bot ids
    assert.deepEqual([my_bot1, my_bot2], people.get_all_bots_for_current_user());
