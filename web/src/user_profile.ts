    ...
    $("body").on("click", "button.bot-modal-regenerate-bot-api-key", (e) => {
        ...
        void channel.post({
            ...
            success(data) {
                ...
                $row.find(".bot-modal-info").find(".bot-modal-value").text(parsedData.api_key);
            ...
            error(xhr) {
                ...
                if (parsedErrorData) {
                    ...
                    $row.find(".bot-card-api-key-error").text(parsedErrorData.msg).show();
                }
            },
        });
    });
