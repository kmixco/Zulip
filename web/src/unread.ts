...
// calculate keys.
//
// Functionally a cache; see clear_and_populate_unread_mention
...
function add_message_to_unread_mention(message_id: number): void {
...
function remove_message_from_unread_mention(message_id: number): void {
...
export function clear_and_populate_unread_mention(): void {
...
export function update_message_for_mention(
    ...
    if (!message.unread) {
        ...
        remove_message_from_unread_mention(message.id);
        return false;
    }
    ...
    if (is_unmuted_mention || message.mentioned_me_directly) {
        ...
        add_message_to_unread_mention(message.id);
        if (message.type === "private") {
...
export function mark_as_read(message_id: number): void {
    ...
    remove_message_from_unread_mention(message_id);
...
export function initialize(params: StateData["unread"]): void {
    ...
    clear_and_populate_unread_mention();
