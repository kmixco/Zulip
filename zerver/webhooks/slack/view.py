...
def handle_send_webhook_message(
    request: HttpRequest,
    ...
    *,
    ...
    if event_type == "message":
        ...
        if sender is None:
            ...
            # messages doesn't have a user profile and require additional formatting
            # to handle. Refer to the Slack Incoming Webhook integration for how to
            # add support for this type of payload.
        ...
        handle_send_webhook_message(
            request, user_profile, topic_name, content, channel, channels_map_to_topics
        )
    else:
