...
class RealmImportExportTest(ExportFile):
    ...
    def test_import_realm(self) -> None:
        ...
        topic_link_message = (
            f"[topic near link](#narrow/stream/{denmark_stream.id}-Denmark/topic/test)"
        )
        ...
        near_link_message = f"[message near link](#narrow/stream/{denmark_stream.id}-Denmark/topic/test/near/{near_link_target_message_id})"
        ...
        self.assertEqual(
            ...
            f'<p><a href="#narrow/stream/{imported_denmark_stream.id}-Denmark">channel near link</a></p>',
        )
        ...
        self.assertEqual(
            ...
            f'<p><a href="#narrow/stream/{imported_denmark_stream.id}-Denmark/topic/test">topic near link</a></p>',
        )
        ...
        self.assertEqual(
            ...
            f'<p><a href="#narrow/stream/{imported_denmark_stream.id}-Denmark/topic/test/near/{imported_near_link_target_message.id}">message near link</a></p>',
        )
